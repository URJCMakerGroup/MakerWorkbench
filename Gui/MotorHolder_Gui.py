...
class MotorHolder_TaskPanel:
    def __init__(self):
        ...
        # ---- Image ----
        image = QtWidgets.QLabel('Image of points and axis <a href="https://raw.githubusercontent.com/davidmubernal/Mechatronic_Documentation/master/img_gui/MotorHolder.png">here</a>.')
