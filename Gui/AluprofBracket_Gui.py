...
class AluprofBracket_TaskPanel:
    def __init__(self):
        ...
        # ---- Image ----
        image = QtWidgets.QLabel('Image of axis <a href="https://raw.githubusercontent.com/davidmubernal/Mechatronic_Documentation/master/img_gui/AluprofBracket.png">here</a>.')
