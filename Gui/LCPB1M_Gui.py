...
class Lcpb1mBase_TaskPanel:
    def __init__(self):
        ...
        # ---- row 6: image ----
        image = QtWidgets.QLabel('Image of axis <a href="https://raw.githubusercontent.com/davidmubernal/Mechatronic_Documentation/master/img_gui/LCPB1MBase.png">here</a>.')
