...
class BeltClamped_TaskPanel:
    def __init__(self):
        ...
        # ---- Image ----
        image = QtWidgets.QLabel('Image of points and axis <a href="https://raw.githubusercontent.com/davidmubernal/Mechatronic_Documentation/master/img_gui/BeltClamped.png">hear</a>.')
