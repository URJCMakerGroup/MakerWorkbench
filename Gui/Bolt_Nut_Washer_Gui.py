...
class Bolt_TaskPanel:
    def __init__(self):
        ...
        # ---- row 9: image ----
        image = QtWidgets.QLabel('Image of points and axis <a href="https://raw.githubusercontent.com/davidmubernal/Mechatronic_Documentation/master/img_gui/Bolt_Nut_Washer.png">hear</a>.')
